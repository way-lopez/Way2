...
function finishBattle(win){
  ...
  el("resultText").textContent = win
    ? (gameState.save.level > previousLevel ? "Você venceu e subiu de nível." : "Você venceu no nível máximo.")
    : "Você perdeu. Ajuste sua estratégia e tente novamente.";
  ...
  el("resultStats").innerHTML = `
    ...
    <div class="stat-row"><span>Vitórias / Derrotas</span><strong>${gameState.save.wins} / ${gameState.save.losses}</strong></div>
  `;
  showScreen("result");
