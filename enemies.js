...
function getEnemyStarterDeck(level, saveState = null){
  let deck = buildStarterDeck(saveState);
...
function buildEnemyDeck(level, botChoices, saveState = null){
  const profile = getEnemyProfile(level);
  let deck = getEnemyStarterDeck(level, saveState);
